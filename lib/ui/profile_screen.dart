...
class _ProfileStatsScreenState extends State<ProfileStatsScreen> {
  ...
  Widget _buildNameCard() {
    ...
    final fullName = '${firstName.isNotEmpty ? firstName : ''} ${lastName.isNotEmpty ? lastName : ''}'.trim();
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildInfoCard(
                                ...
                                value: _userData!['contact_number'] as String? ?? '',
                      ...
                      const SizedBox(height: 16.0),
                      Divider(thickness: 1, indent: 16, endIndent: 16, color: Colors.grey.withOpacity(0.3)),
                      const SizedBox(height: 16.0),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              _buildInfoCard(
                                title: 'Organization',
                                value: _userData!['organization_name'] as String? ?? '',
                                icon: Icons.business_outlined,
                              ),
                              _buildInfoCard(
                                title: 'Organization ID',
                                value: _userData!['organization'] as String? ?? '',
