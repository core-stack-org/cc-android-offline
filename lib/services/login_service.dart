...
class LoginService {
  ...
  Future<void> _storeAuthData(String accessToken, String refreshToken, Map<String, dynamic> userData) async {
    ...
    // Calculate and store access token expiry (2 days from now)
  ...
  Future<bool> isAccessTokenExpired() async {
    ...
    return true; // If no expiry info, consider expired
  }
  ...
  Future<void> logout() async {
    try {
      ...
      final response = await makeAuthenticatedRequest('auth/logout/', method: 'POST');
      if (response != null) {
